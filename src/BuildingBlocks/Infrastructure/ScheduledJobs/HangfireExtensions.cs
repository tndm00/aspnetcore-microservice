...
namespace Infrastructure.ScheduledJobs
{
    ...
    {
        public static IServiceCollection AddTndmHangfireService(this IServiceCollection services)
        {
            ...
            if (settings == null || settings.Storage == null ||
                ...
                throw new Exception("HaneFireSettings is not configured properly!");
        ...
        private static IServiceCollection ConfigureHangfireServices(this IServiceCollection services, HangFireSettings settings)
        {
            ...
            switch (settings.Storage.DBProvider.ToLower())
            {
                case "mongodb":
                    ...
                    var mongoStoregeOptions = new MongoStorageOptions
                    {
                    ...
                    services.AddHangfire((provider, config) =>
                    {
                        ...
                        .UseConsole()
                        .UseMongoStorage(mongoClient, mongoUrlBuilder.DatabaseName, mongoStoregeOptions);
                ...
                default:
                    throw new Exception($"HangFire Storage Provider {settings.Storage.DBProvider}");
            }
